...
<div class="topnav">
	<a href="adminBELIANsenarai.php"><i class="fa fa-shopping-cart"></i> Senarai Jualan</a> <!--pergi ke admin tambah nilai-->
  <div class="dropdown">   
      <button class="dropbtn"><i class="fa fa-list-ol"></i> Produk <!--butang dropdown-->
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="adminITEMsenarai.php"><i class="fa fa-list-ul"></i> Senarai Produk</a> <!--pergi ke admin senarai produk-->
      <a href="adminITEMtambah.php"><i class="fa fa-plus"></i> Tambah Produk</a> <!--pergi ke admin item tambah-->
    </div>
  </div>     
  <a href="adminNILAItambah.php"><i class="fa fa-plus"></i> Tambah Nilai</a> <!--pergi ke admin tambah nilai-->
    <div class="dropdown">  
      <button class="dropbtn"><i class="fa fa-user-circle"></i> Pengguna <!--butang dropdown-->  
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a href="adminPENGGUNAsenarai.php"><i class="fa fa-list-alt"></i> Senarai Pengguna</a> <!--pergi ke admin pengguna senarai-->
      <a href="adminUPLOADpengguna.php"><i class="fa fa-upload"></i> Muat Naik Senarai Pengguna</a> <!--pergi ke admin muat naik senarai pengguna-->
    </div>
  </div>
  <div class="dropdown">  
    ...
    <div class="dropdown-content">
      <a href="manualPENGURUSvideo.php"><i class="fa fa-file-video-o"></i> Video Manual Pengurus</a> <!--pergi video manual pengguna-->
      <a href="dokumen/manualPENGGUNA.pdf" target="_blank"><i class="fa fa-address-book-o"></i> Manual Pengguna</a> <!--pergi manual pengguna-->
