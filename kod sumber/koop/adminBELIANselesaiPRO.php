<?php //fastkop update "selesai" selepas beri bungkusan
...
mysqli_query($conntodb,"UPDATE tbl_resit SET statusfastkop = 'Selesai' WHERE idresit = '$idresit'");
...
<script language="javascript">
		alert("Pesanan telah diserahkan");
