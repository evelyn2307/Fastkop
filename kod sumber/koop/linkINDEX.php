...
<div class="topnav">   
	<a href="welcome.php"><i class="fa fa-home"></i> Utama</a><!--pergi ke utama-->
    <a href="indexITEMsenarai.php"><i class="fa fa-list-ol"></i> Produk</a><!--pergi ke item senarai-->
    <a href="login.php"><i class="fa fa-external-link-square"></i> Log Masuk</a> <!--pergi ke log masuk-->
	<a href="penggunaTAMBAH.php"><i class="fa fa-user-plus"></i> Daftar Pengguna Baharu</a> <!--pergi ke daftar pengguna-->
    <div class="dropdown">  
